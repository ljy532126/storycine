...
const settingsSchema = new mongoose.Schema({
  ...
  ttsConfig: {
    ...
    emotionScale: { type: Number, default: 4 },
    enableSubtitle: { type: Boolean, default: true },
    disableMarkdownFilter: { type: Boolean, default: true },
    useCache: { type: Boolean, default: true },
    useTagParser: { type: Boolean, default: false },
    explicitLanguage: { type: String, default: 'zh-cn' },
    silenceDuration: { type: Number, default: 0 },
    model: { type: String, default: 'seed-tts-2.0-standard' },
