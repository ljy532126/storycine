...
const DEFAULT_GENRES = [
  '都市爱情', '古代言情', '悬疑推理', '科幻未来', '奇幻仙侠', '校园青春', '家庭伦理', '职场商战', '武侠江湖', '恐怖惊悚',
  '民国风云', '宫斗宅斗', '重生复仇', '末日生存', '黑道风云', '娱乐圈', '电竞网游', '军旅热血', '乡村致富', '医疗救援',
  '律政法庭', '盗墓冒险', '神话传说', '西方奇幻', 'ABO设定', '无限流', '赛博朋克', '都市异闻', '灵异鬼怪', '公路旅行',
  '极地探险', '深海攻略', '二次元', '运动竞技', '美食烹饪', '时尚设计', '音乐舞蹈', '宠物温情', '人工智能', '太空歌剧',
  '历史架空', '谍战特工', '红色革命', '海外华人', '多子多福', '搞笑沙雕', '冷笑话', '恶搞', '翻拍经典', '现实主义',
  '传记人生', '文艺片', '短剧集', '迷你剧',
];
const DEFAULT_PLOTS = [
  '霸道总裁', '失忆', '重生', '穿越', '替身', '闪婚', '复仇', '逆袭', '误会', '渣男', '绿茶', '追妻火葬场', '先婚后爱', '豪门',
  '契约婚姻', '天才宝宝', '系统', '末世', '天降', '竹马', '白月光', '双重生', '掉马甲', '读心术', '预言梦', '时间循环',
  '扮猪吃虎', '病娇', '疯批', '白切黑', '扮丑逆袭', '真假千金', '替身文学', '带球跑', '叔嫂', '姐弟恋', '年下', '破镜重圆',
  '暗恋成真', '双向奔赴', '追星成功', '穿书', '穿游戏', '穿成反派', '打脸', '虐渣', '团宠', '万人嫌逆袭', '开局签到',
  '金手指', '异能觉醒', '灵气复苏', '空间', '红包群', '红包', '神豪', '返老还童', '变形计', '灵魂互换', '性别互换',
  '伪装', '卧底', '整容', '假装', '契约', '联姻', '逃婚', '代驾', '误诊', '绝症', '失联', '寻亲', '认祖归宗', '豪门弃少',
  '赘婿逆袭', '最强兵王', '神医下山', '国术宗师', '龙王回归', '战神归来', '幕后大佬', '巨富千金', '御兽', '算命',
  '风水相师', '鉴宝', '赌石', '文物修复', '悬疑', '密室逃脱', '剧本杀', '孤岛求生', '试炼', '淘汰赛', 'PK', '打榜',
  '选秀', '爆红', '塌房', '潜规则', '包养', '虐恋', '囚禁', '强制爱', '偏执占有', '黑化', '反转', '神转折', '猝不及防',
  '认错人', '躺平', '摆烂', '社恐', '社交牛逼症', '嘴炮', '吐槽', '弹幕互动', '第四面墙', '元叙事',
  '高手在民间', '校花', '校草', '学霸', '学渣', '班花', '班草', '小奶狗', '小狼狗', '年上',
  '双胞胎', '混血', '异瞳', '白发', '红发', '纹身', '伤疤', '残疾', '轮椅', '盲人',
  '异世界', '魔法学院', '骑士团', '佣兵团', '冒险者公会', '魔王', '勇者', '精灵', '矮人', '兽人',
  '龙族', '吸血鬼', '狼人', '丧尸', '变异', '进化', '超能力', '基因改造', '克隆人', '仿生人',
  '机器人', '外星人', '星际殖民', '虫族', '机甲', '星舰', '跃迁', '黑洞', '时间旅行', '平行宇宙',
  '万人迷', '修罗场', '后宫', '逆后宫', '血族', '圣女', '魔女', '预言家', '占卜师', '女巫',
  '猎魔人', '驱魔', '除灵', '妖怪', '精怪', '聊斋', '鬼故事', '民间传说', '山海经', '克苏鲁',
  '搞笑日常', '社死现场', '打工人', '职场摸鱼', '甲方乙方', '内卷', 'PUA', '精神内耗', '谐音梗', '无聊图',
  '神回复', '吐槽大会', '段子手', '毒鸡汤', '反套路', '意难平', '刀', '发糖', '撒狗粮', '虐狗',
];
const DEFAULT_TYPES = [
  '爱情', '悬疑', '喜剧', '虐心', '爽文', '甜宠', '惊悚', '热血', '治愈', '复仇爽文', '虐恋情深', '轻松搞笑', '烧脑悬疑',
  '逆袭打脸', '双向暗恋', '大女主', '双强', '病娇偏执', '救赎治愈', '快节奏', '慢热细腻', '无CP', '单元剧', '连续剧',
  '悲剧', '开放式结局', 'HE', 'BE', '暗黑', '文艺', '意识流', '黑色幽默', '讽刺', '荒诞',
  '青春', '暗恋', '初恋', '黄昏恋', '禁忌之恋', '年上', 'ABO', '耽美', '百合', '纯爱',
  '冒险', '探险', '探案', '法医', '犯罪心理', '侧写', '高智商', '本格推理', '社会派', '硬核科幻',
  '奇幻', '魔法', '修真', '修仙', '凡人流', '洪荒', '商战', '种田', '基建', '科技兴国',
  '历史', '权谋', '官场', '战争', '军事', '抗战', '谍战', '军婚', '警匪', '扫黑',
  '反腐', '职场', '办公室', '金融', '炒股', '创业', '美食', '旅游', '纪录片风', '访谈式',
  '说唱', '国风', '电音', '土味', '鬼畜', '配音', '模仿', '翻拍', '原创', '改编',
  '冷笑话', '神评论', '弹幕', '评论区', '直播间', '带货', '开箱', '测评', '吐槽', '安利',
];
const DEFAULT_STYLES = [
  '写实', '古风', '现代', '轻喜', '虐心', '甜宠', '高燃', '暗黑', '温馨', '文艺', '日系', '韩系', '港风', '民国',
  '赛博朋克', '废土', '玄幻', '仙气', '胶片感', '极简', '油画风', '水墨', '二次元', '美漫', '像素风', '波普',
  '印象派', '复古', '蒸汽朋克', '哥特', '巴洛克', '洛可可', '唐朝', '汉服', '清朝', '八十年代',
  '九十年代', 'Y2K', '千禧', '昭和', '平成', '北欧', '极简', '侘寂', '波西米亚', '工业风',
  '纪录片风', '纪实', '手持镜头', '长镜头', '一镜到底', '慢镜头', '延时', '微距', '鱼眼', '黑白',
  '默片', '伪纪录片', 'Vlog', '短视频风', '直播间', '监控视角', '偷拍视角', '新闻片', 'MV风', '广告大片',
];
