  ...
  <div class="page">
    ...
    <div v-show="settingsTab === 'image'" class="st-section">
      <div class="ac-grid">
        ...
        <div class="ac-card">
          <h3 class="ac-card-title">画质 / 风格</h3>
        ...
        <div class="ac-card">
          <h3 class="ac-card-title">豆包安全策略</h3>
...
.ac-llm-actions .el-button--primary {
  ...
  border: 2px solid #67c23a !important; color: #67c23a !important;
}
...
.ac-llm-actions .el-button--default:hover {
  border-color: var(--gold) !important; color: var(--gold) !important; transform: translateY(-1px);
}
.ac-llm-actions .el-button--success {
  background: rgba(103,194,58,0.06) !important; border: 2px solid #67c23a !important; color: #67c23a !important;
}
.ac-llm-actions .el-button--danger {
  background: rgba(245,108,108,0.06) !important; border: 2px solid #f56c6c !important; color: #f56c6c !important;
}
